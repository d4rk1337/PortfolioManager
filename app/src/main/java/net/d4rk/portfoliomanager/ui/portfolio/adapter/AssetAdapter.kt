...
class AssetAdapter() :
    ...
    var assets = mutableListOf<BinanceApiResponse.Ticker>()

    fun setNewAssets(newassets: List<BinanceApiResponse.Ticker>) {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.symbolView.text = assets[position].symbol
        viewHolder.priceView.text = assets[position].price.toString()
    }
